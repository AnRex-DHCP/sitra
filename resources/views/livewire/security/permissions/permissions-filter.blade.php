<div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
    <div class="offcanvas-header bg-light">
        <h5 class="offcanvas-title" id="offcanvasExampleLabel">Filtros de Permisos</h5>
    ...
    <div class="offcanvas-body">
            <div class="mb-4">
                <label for="module" class="form-label text-muted text-uppercase fw-semibold mb-3">Módulo</label>
                <select class="form-select" wire:model="filters.module_id" id="module">
